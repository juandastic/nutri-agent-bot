    ...
    async def register_nutritional_info(
        ...
        try:
            ...
            if spreadsheet_id:
                ...
                response_parts.append(
                    "The data has been saved to your internal records, if you want to see it in your Google Sheet, you need to connect your Google account, ask me how in case you want to do that."
                )
